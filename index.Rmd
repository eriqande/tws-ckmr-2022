...
8:45--9:30    | An introduction to genetic data and inheritance  | _E. Anderson_ |
9:30--9:45    | Break |   |
9:45--10:30   | Statistical inference for CKMR estimation | _P. Conn_ |  
10:30--11:15  | Kin finding  |  _E. Anderson_   |  
11:15--12:00  | Designing a CKMR experiment  | _P. Conn_  |
12:00--1:00   | Lunch   |
...
6. To get all the packages, paste these lines into your R console in RStudio:
    ...
    renv::restore()
    ```
    That should start what might be a fairly lengthy process of downloading, compiling
    (a few, at least) and installing all the R packages we need, and their dependencies.
    At the end of all that, 'renv' should give you a list of all the packages that will
