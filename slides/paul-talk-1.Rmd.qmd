...
7. A CKMR case study: Bearded seals
...
Slides for morning lectures: [https://github.com/eriqande/tws-ckmr-2022/tree/main/slides](https://github.com/eriqande/tws-ckmr-2022/tree/main/slides)
...
## CKMR Assumptions - Implications {background-image="quarto-static/slideswoosh-white.png" background-size="contain"}
 ...
 2. Population model is accurate
...
Accurate sampling models have more to do with independent fates.  E.g. we won't want to model mothers and offspring harvested
in the same year.
...
If covariates are available, and important, they should be modeled!  In some cases, e.g., heterogeneity in reproductive
success due to dominance, we might need to leave out father-offspring comparisons or model them differently somehow (see bearded
seal example). 
...
Our paper isn't published yet so I can't make data public yet. So I "adjusted" a few data points so it still tells the same
general story but can't be scooped because it's not real data.

![](paul1-images/bearded_cameron.png)


## A CKMR case study: Weirded seals! {background-image="quarto-static/slideswoosh-white.png" background-size="contain"}

Our paper isn't published yet so I can't make data public yet. So I "adjusted" a few data points so it still tells the same
general story but can't be scooped because it's not real data.

![](paul1-images/bearded_white.jpg)
